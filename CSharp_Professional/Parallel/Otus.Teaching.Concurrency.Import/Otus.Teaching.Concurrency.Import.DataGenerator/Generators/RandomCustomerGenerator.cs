...
namespace Otus.Teaching.Concurrency.Import.DataGenerator.Generators
{
    public static class RandomCustomerGenerator
    {
        ...
        public static Customer GenerateOneCustomer()
        {
            var customer = new Customer();

            customer = new Faker<Customer>()
                .RuleFor(u => u.Id, (f, u) => new Random().Next(0, 2000000))
                .RuleFor(u => u.FullName, (f, u) => f.Name.FullName())
                .RuleFor(u => u.Email, (f, u) => f.Internet.Email(u.FullName))
                .RuleFor(u => u.Phone, (f, u) => f.Phone.PhoneNumber("1-###-###-####")).Generate();
